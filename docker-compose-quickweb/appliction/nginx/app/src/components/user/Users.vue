      ...
      <el-table :data="userlist" style="width: 100%">
        ...
        <el-table-column prop="is_superuser" label="管理员">
          <template #default="{ row }">
            <el-button v-if="row.is_superuser ===true" type="success" icon="el-icon-check" circle size="mini"></el-button>
            <el-button v-else-if="row.is_superuser ===false" type="info" icon="el-icon-close" circle size="mini"></el-button>
        ...
        <el-table-column prop="" label="操作">
          <template #default="{ row }">
            <el-tooltip content="分配角色" placement="top">
              <el-button v-if="row.id !=1" v-model="noEdit" type="info" icon="el-icon-setting" circle @click="handleEditRole(row)"></el-button>
              <el-button v-else-if="row.id ===1" v-model="noRole" disabled type="info" icon="el-icon-setting" circle @click="handleEditRole(row)"></el-button>
            </el-tooltip>

            <el-tooltip content="编辑用户" placement="top">
              <el-button v-if="row.id !=1"   type="primary" icon="el-icon-edit" circle @click="handleEditUser(row)"></el-button>
              <el-button v-else-if="row.id ===1" v-model="noEdit" disabled type="primary" icon="el-icon-edit" circle @click="handleEditUser(row)"></el-button>
            </el-tooltip>

            <el-tooltip content="删除用户" placement="top">
              <el-button v-if="row.id !=1" type="danger" icon="el-icon-delete" circle @click="handleDelete(row)"></el-button>
              <el-button v-else-if="row.id ===1" v-model="noDel" disabled type="danger" icon="el-icon-delete" circle @click="handleDelete(row)"></el-button>
            </el-tooltip>
          </template>
        </el-table-column>
      </el-table>
